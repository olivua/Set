...
void drawButtons() {
  ...
  text("Add Cards", BUTTON_LEFT_OFFSET+10, BUTTON_TOP_OFFSET+22); 
  text("Find Set", BUTTON_LEFT_OFFSET+18+BUTTON_WIDTH+20, BUTTON_TOP_OFFSET+22); 
  text("New Game", BUTTON_LEFT_OFFSET+18+2*(BUTTON_WIDTH+11), BUTTON_TOP_OFFSET+22); 
  text("Hint", BUTTON_LEFT_OFFSET+18+5*(BUTTON_WIDTH - 20), BUTTON_TOP_OFFSET+22); 
...
//creates a new deck and grid 
//sets the score, currentCols, states, times, message to starting values
//adds (currentCols * ROW) cards to the board 
public void newGame() {
  ...
  for(int cards = 0; cards < currentCols * ROWS; cards++)
  {
...
public void showMessage() {
 ...
 //hint extension
    case 11: str = "Same Color"; break;
    case 12: str = "Same Shape"; break;
    case 13: str = "Same Fill"; break;
    case 14: str = "Same Count"; break;
    case 15: str = "Different Color"; break;
    case 16: str = "Different Shape"; break;
    case 17: str = "Different Fill"; break;
    case 18: str = "Different Count"; break;
